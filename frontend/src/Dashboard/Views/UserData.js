...
const UserData = () => {
    return (
        <div>
            <div class="md:grid md:grid-cols-4 md:gap-46">
    <div class="md:col-span-1">
      <div class="px-4 sm:px-0">
        <h3 class="text-2xl xl:text-3xl font-extrabold">Profile</h3>
        <p class="my-5  text-sm lg:text-base font-medium text-gray-600 max-w-lg mx-auto lg:mx-0">
